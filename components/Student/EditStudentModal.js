    ...
    return ReactDOM.createPortal(
        <div className={style.portalContainer}>
            <div className={style.addStudentModal}>
                <h4 className={style.editStudentFormTitle}>Edit student information</h4>

                <form className={style.addStudentForm} onSubmit={handleSubmit}>
                    <div className={style.editStudentFormInputs}>
                        <label>First
                            <input
                        ...
                        <label>Leave start date
                            <input
                                required
                                className={`${style.addStudentFormInput} ${style.editStudentDate}`}
                                type='date'
                                onChange={handleChange}
                    ...
                    {userData.admin ? null : <div className={style.myInterestsDiv}>
                        <label>My interests:</label>
                        <textarea
                            className={style.editInterestsTextarea}
                            type='text'
                            onChange={handleChange}
                            name='interests'
